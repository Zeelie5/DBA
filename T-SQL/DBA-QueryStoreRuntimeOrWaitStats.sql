...
IF @MetricDESC = 'Runtime'
  ...
  BEGIN
    ...
    INNER JOIN sys.query_store_runtime_stats ON query_store_plan.plan_id = query_store_runtime_stats.plan_id
    WHERE
...
IF @MetricDESC = 'Wait'
  ...
  BEGIN
    ...
    INNER JOIN sys.query_store_plan ON query_store_query.query_id = query_store_plan.query_id 
    INNER JOIN sys.query_store_runtime_stats ON query_store_plan.plan_id = query_store_runtime_stats.plan_id
    INNER JOIN sys.query_store_wait_stats ON query_store_runtime_stats.plan_id = query_store_wait_stats.plan_id AND
